...
for i in range(1, 3):
    ...
    driver.get("https://www.aladin.co.kr/shop/common/wbest.aspx?BestType=EBookBestseller&BranchType=9&CID=38398&page="+str(i)+"&cnt=300&SortOrder=1")
    time.sleep(0.5)
...
df.to_csv("알라딘_경제경영" + '.csv', index = False, encoding = 'utf-8-sig')
# # df.to_excel("알라딘_경제경영" + '.xls', index = False, encoding = "utf-8-sig")
